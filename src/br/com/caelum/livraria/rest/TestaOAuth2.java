...
public class TestaOAuth2 {
	...
	public static void main(String[] args) throws OAuthSystemException, OAuthProblemException, URISyntaxException {
		...
		OAuthClientRequest request = OAuthClientRequest
				.tokenLocation(tokenEndPoint).setGrantType(GrantType.PASSWORD)
		...
		String entity = target.request(MediaType.APPLICATION_XML_TYPE).header("Authorization", "Bearer " + oAuthResponse.getAccessToken()).get(String.class);
